    ...
    if (manifestSection['columns']) {
        ...
        if (lineItems) {
            for (const columnKey in lineItems.properties) {
                ...
                (0, utils_1.transferSettingsOfObject)(columnInConfig, importParameters.manifest, importParameters.jsonSchema.definitions[tableDefinition], importParameters.routingId, [columnKey], manifestSectionId);
    ...
    if (typeof actionsDefinition === 'object') {
        for (const actionKey in actionsDefinition['properties']) {
            ...
            if (typeof actionDefinition === 'object' && actionDefinition.$ref) {
                ...
                (0, utils_1.transferSettingsOfObject)(configPart[sectionId].table.toolBar.actions[actionKey], importParameters.manifest, importParameters.jsonSchema.definitions[definitionKey], importParameters.routingId, [actionKey], manifestSectionId);
    ...
    if (manifestSection['actions']) {
        ...
        for (const actionKey in actionsDefinition['properties']) {
            ...
            if (formActionDefinition['annotationType'] === "com.sap.vocabularies.UI.v1.DataFieldForAction" /* UIAnnotationTypes.DataFieldForAction */ ||
                ...
                (0, utils_1.transferSettingsOfObject)(configPart[sectionId].form.actions[actionKey], importParameters.manifest, importParameters.jsonSchema.definitions[formActionKey], importParameters.routingId, [actionKey.replace('/', '??')], manifestSectionId);
...
function fillTableInConfig(importParameters, manifestSettings, configPart, sectionId, factory, tableId) {
    ...
    if (manifestSection) {
        ...
        (0, utils_1.transferSettingsOfObject)(configPart[sectionId].table, importParameters.manifest, importParameters.jsonSchema.definitions[sectionDefinition], importParameters.routingId, [], manifestSectionId);
...
function fillCustomSectionsInConfig(importParameters, manifestSettings, objectPageConfig, factory) {
    ...
    if (customSections) {
        ...
        for (const sectionId in customSections) {
            ...
            (0, utils_1.transferSettingsOfObject)(section, importParameters.manifest, importParameters.jsonSchema.definitions[ux_specification_types_1.DefinitionName.ObjectPageCustomSectionFragment], importParameters.routingId, [], sectionId);
            const fragmentName = customSections[sectionId].template;
            if (fragmentName) {
    ...
    if (headerSections && headerSections.properties) {
        ...
        for (const sectionId in headerSections.properties) {
            ...
            objectPageConfig.header.sections[sectionId] = factoryKey
                ...
                : {};
            (0, utils_1.transferSettingsOfObject)(objectPageConfig.header.sections[sectionId], manifest, sectionDefinition, routingId, [], sectionDefinition?.title?.split(ux_specification_types_1.FacetTitlePrefix)[1]);
        }
    }
}
/**
    ...
    if (typeof actions === 'object') {
        ...
        for (const actionKey in actions.properties) {
            ...
            if (typeof definition === 'object' && definition.$ref) {
                ...
                (0, utils_1.transferSettingsOfObject)(objectPageConfig[actionType].actions[actionKey], manifest, appSchema.definitions[key], routingId, [actionKey.replace('/', '??')]);
...
function fillObjectPageConfig(importParameters, v4Page, factory) {
    ...
    (0, utils_1.transferSettingsOfObject)(objectPageConfig.header, importParameters.manifest, importParameters.jsonSchema.definitions[ux_specification_types_1.DefinitionName.ObjectPageHeader], importParameters.routingId, []);
    ...
    (0, utils_1.transferSettingsOfObject)(objectPageConfig.footer, importParameters.manifest, importParameters.jsonSchema.definitions[ux_specification_types_1.DefinitionName.ObjectPageFooter], importParameters.routingId, []);
    ...
    (0, utils_1.transferSettingsOfObject)(objectPageConfig.layout, importParameters.manifest, importParameters.jsonSchema.definitions[ux_specification_types_1.DefinitionName.ObjectPageLayout], importParameters.routingId, []);
    (0, utils_1.transferSettingsOfObject)(objectPageConfig, importParameters.manifest, importParameters.jsonSchema, importParameters.routingId, []);
